...
object DatabaseModule {
    ...
    @Provides fun providePropostaClubeDao(db: AppDatabase): PropostaClubeDao = db.propostaClubeDao()
    @Provides fun provideTecnicoDao(db: AppDatabase): TecnicoDao = db.tecnicoDao()
}
